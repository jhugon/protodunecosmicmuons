...
if __name__ == "__main__":
  ...
  thetaz = root.TH1F("thetaz","",100,0,math.pi)
  ...
  thetaz2 = root.TH1F("thetaz2","",100,0,math.pi)
  ...
  thetaz3 = root.TH1F("thetaz3","",100,0,math.pi)
  ...
  thetaz4 = root.TH1F("thetaz4","",100,0,math.pi)
  ...
  setHistTitles(thetaz,"Muon Starting zenith angle [radians]","Events/bin")
  setHistTitles(phiz,"Muon Starting azimuthal angle with zenith [radians]","Events/bin")
  
  particles = makeParticles("jti3/AntiMuonCutEvents_1000000.txt",10000)
  particles2 = makeParticles("jti3/DATAte",1000)
  particles3 = makeParticles("MillionEvents_RawData_3/AntiMuonCutEvents_1000000.txt",10000)
  particles4 = makeParticles("hamlet.txt",10000)
  for particle in particles:
    xb.Fill(particle.x)
    yb.Fill(particle.y)
    zb.Fill(particle.z)
    thetaz.Fill(particle.thetaz)
    phiz.Fill(particle.phiz)
  for particle in particles2:
    xb2.Fill(particle.x)
    yb2.Fill(particle.y)
    zb2.Fill(particle.z)
    thetaz2.Fill(particle.thetaz)
    phiz2.Fill(particle.phiz)
  for particle in particles3:
    xb3.Fill(particle.x)
    yb3.Fill(particle.y)
    zb3.Fill(particle.z)
    thetaz3.Fill(particle.thetaz)
    phiz3.Fill(particle.phiz)
  for particle in particles4:
    xb4.Fill(particle.x)
    yb4.Fill(particle.y)
    zb4.Fill(particle.z)
    thetaz4.Fill(particle.thetaz)
